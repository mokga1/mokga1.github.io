...
const T = [
  ...
  ['보조직업 기능도 구슬을 소모하므로 훈련 비용 계산에 그대로 포함됩니다. 다만 스팀판(Eternal War)은 보조직업이 연금술사·재봉사·대장장이·바드 <b>4종만</b> 열려 있습니다. 이 4종은 주직업이 무엇이든 자유롭게 고를 수 있습니다.',
   'Sub-job skills consume orbs too, so they are counted in the training cost like any other. Note that the Steam release (Eternal War) opens <b>only four</b> sub jobs — Alchemist, Tailor, Blacksmith and Bard. Any main job may take any of the four.'],
