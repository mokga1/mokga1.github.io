...
const T = [
  ...
  ['<a href="guide/orbs.html">📖 구슬 시스템</a>', '<a href="../">🇰🇷 한국어 (Korean version)</a>'],
  ['<a href="guide/beginner.html">초보 가이드</a>', ''],
  ['<a href="guide/reroll.html">리세마라</a>', ''],
  ['<a href="guide/warrior.html">전사 공략</a>', ''],
  ['<a href="guide/fighter.html">검투사 공략</a>', ''],
  ['<a href="guide/thief.html">도둑 공략</a>', ''],
  ['<a href="guide/wizard.html">마법사 공략</a>', ''],
  ['<a href="guide/cleric.html">성직자 공략</a>', ''],
